...
public class GetCareersDataTask extends AsyncTask<String, String, String>{
    ...
    protected String doInBackground(String... urls) {
        ...
        careers = Utilities.getCareers(resultString);
    ...
    protected void onPostExecute(String result) {
    	...
    	adapter.setItems(careers.getCareers());
	...
	public void setAdapter(CareersArrayListAdapter a) {
		adapter = a;
